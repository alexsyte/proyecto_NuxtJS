<!--Tabla donde nos traeremos los animales de nuestra base de datos de firebase-->
<template>
  <div>
    <section class="section" >
      <div class="columns">
        <div class="column">
          <h2 class="title is-2">Animales en la BD</h2>
        </div>
      </div>
      <div class="table-container">
        ...
        <button class="button" @click="$router.back()">
         ...
         <button class="button" @click="aniadir()">
          Añadir un nuevo animal a la BD
        </button>
        <br><br>
...
export default {
    ...
    methods:{
        ...
        getDocuments(){
            //Lo inicializamos siempre a vacío para que cada vez que borremos un animales y volvamos a ejecutar este método no se vuelva a añadir a la variable creada
            this.animales=[]
            // Traer los animales
        ...
        aniadir(){
          this.$router.push('/admin/aniadirAnimal')
        }
    }
}
</script>